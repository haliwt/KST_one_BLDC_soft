...
void HAL_TIM_TriggerCallback(TIM_HandleTypeDef *htim)
{
  ...
  switch(uwStep)
  {
    case 1://C+ A-
      ...
      __HAL_TIM_SET_COMPARE(&htimx_BLDC,TIM_CHANNEL_3,BLDCMOTOR_TIM_PERIOD * PWM_Duty);
    ...
    case 2: //A+  B-
      ...
      /*  Channel configuration  */
      __HAL_TIM_SET_COMPARE(&htimx_BLDC,TIM_CHANNEL_1,BLDCMOTOR_TIM_PERIOD * PWM_Duty);
    ...
    case 4:// B+ C-
      ...
      /*  Channe2 configuration */
      __HAL_TIM_SET_COMPARE(&htimx_BLDC,TIM_CHANNEL_2,BLDCMOTOR_TIM_PERIOD * PWM_Duty);
